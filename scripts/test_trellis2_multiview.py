...
print("Initializing VisualBruno ComfyUI-Trellis2 MultiView Test...", flush=True)
...
print("Step 3: Generating 3D Mesh with Voxel (8GB Optimized, MultiView)...")
...
print("\n=======================================================")
print(f"🎉 VISUALBRUNO TRELLIS2 MULTIVIEW 3D GENERATION SUCCESSFUL!")

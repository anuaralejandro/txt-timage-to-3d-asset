...
print("Step 2: Loading Multi-View Normalized Images from C:\\Users\\datam\\Downloads\\jace0_normalized...")
folder_path = r"C:\Users\datam\Downloads\jace0_normalized"
...
front_tensor = load_img("norm_front.png")
back_tensor = load_img("norm_back.png")
left_tensor = load_img("norm_left.png")
right_tensor = load_img("norm_right.png")
...
print("Step 3: Generating Textured 3D Mesh with Voxel (Full PBR Colors & Sealed Topography)...")
...
print("Step 4: Exporting Textured GLB Asset...")
...
out_glb_path = os.path.join(folder_path, "jace0_normalized_3d_asset.glb")
glb_mesh.export(out_glb_path)

print("\n=======================================================")
print(f"🎉 FULLY TEXTURED & SEALED 3D ASSET GENERATED SUCCESSFULLY!")
